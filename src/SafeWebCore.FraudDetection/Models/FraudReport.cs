...
public sealed record FraudReport
{
    ...
    /// Set when <see cref="Verdict"/> is <see cref="FraudVerdict.FakeWestern"/>.
    /// </summary>
    public bool IsFakeWestern { get; init; }

    /// <summary>
    /// <see langword="true"/> when the resolved IP country is outside the
    /// configured <c>WesternDetectorOptions.AllowedCountries</c> set.
    /// </summary>
    ...
    /// configured thresholds in <c>WesternDetectorOptions</c>.
    /// </summary>
